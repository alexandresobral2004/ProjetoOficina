        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edição de Peças: Almoxarifado</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    
                <input type="hidden" name="id" value="{{ $obj->id ?? '' }}"> <!--pegando o id-->
                    <form action="{{ route('warehouse.update', $obj->id) }}" method="POST"> <!-- alterar para o warehouse  -->
                        @csrf
                         @method('PUT')
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-xxl-3 col-md-3">
                                    ...
                                    <div class="form-group{{ $errors->has('cod') ? ' has-danger' : '' }}">
                                        ...
                                        <input id="cod" type="number" name="cod" placeholder="{{ __('cod') }}"
                                            class="form-control" value="{{ old('cod', $obj->cod ?? '') }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-xxl-4 col-md-4">
                                    ...
                                    <div class="form-group{{ $errors->has('nome_peca') ? ' has-danger' : '' }}">
                                        ...
                                        <input id="nome_peca" type="text" name="nome_peca" placeholder="{{ __('nome_peca') }}"
                                ...
                                <div class="col-xxl-2 col-md-2">
                                    ...
                                    <div class="form-group{{ $errors->has('qtde') ? ' has-danger' : '' }}">
                                        ...
                                        <input id="qtde" type="number" min="0" name="qtde" placeholder="{{ __('qtde') }}"
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-xxl-3 col-md-3"><!-- oitava celula de cadastro: modeloo -->
                                    <div class="form-group{{ $errors->has('modelo') ? ' has-danger' : '' }}">
                                        ...
                                        <input id="modelo" type="text" name="modelo" placeholder="{{ __('modelo') }}"
                                ...
                                <div class="col-xxl-3 col-md-3">
                                    ...
                                    <div class="form-group{{ $errors->has('marca') ? ' has-danger' : '' }}">
                                        ...
                                        <input id="marca" type="text" name="marca"  placeholder="{{ __('marca') }}"
                            ...
                            <div class="row mt-2">
                                <div class="col-xxl-3 col-md-3"><!-- sexta celula de cadastro: menor_preco -->
                                    <div class="form-group{{ $errors->has('margem') ? ' has-danger' : '' }}">
                                        ...
                                        <input id="margem" type="number" min="0" name="margem" placeholder="{{ __('margem') }}"
                                ...
                                <div class="col-xxl-3 col-md-3">
                                    ...
                                    <div class="form-group{{ $errors->has('preco_custo') ? ' has-danger' : '' }}">
                                        ...
                                        <input id="preco_custo" type="number" min="0" name="preco_custo" placeholder="{{ __('preco_custo') }}"
                                ...
                                <div class="col-xxl-3 col-md-3">
                                    ...
                                    <div class="form-group{{ $errors->has('preco_final') ? ' has-danger' : '' }}">
                                        ...
                                        <input id="preco_final" type="number" name="preco_final" placeholder="{{ __('preco_final') }}"
                                            class="form-control{{ $errors->has('preco_final') ? ' is-invalid' : '' }}"
                                            value="{{ old('preco_final', $obj->preco_final ?? '') }}" required readonly>
                                    </div>
                                </div>
                                ...
                                <div class="container mt-1">
                                    ...
                                    <div class="form-group{{ $errors->has('compatibility') ? ' has-danger' : '' }}">
                                        ...
                                        <textarea style="width: 100%" id="compatibility" type="textarea" rows="3" cols="50" name="compatibility"
                                            placeholder="{{ __('compatibility') }}"
                                            class="form-control{{ $errors->has('compatibility') ? ' is-invalid' : '' }}"
                                            required>{{ old('compatibility', $obj->compatibility ?? '') }}</textarea>
                                    </div>
