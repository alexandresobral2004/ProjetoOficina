            ...
            <div class="container-fluid">
                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        < class="collapse menu-dropdown" id="sidebarDashboards">
                            ...
                            <ul class="nav nav-sm flex-column">
                                ...
                                <li class="nav-item">
                                    <a href="#sidebarTickets" class="nav-link" data-bs-toggle="collapse"
                                        ...
                                        data-key="t-supprt-tickets"> Support
                                        Tickets
                                    </a>
                                        ...
                                        <ul class="nav nav-sm flex-column">
                                            ...
                                            <li class="nav-item">
                                                <a href="apps-nft-creators.html" class="nav-link"
                                                    data-key="t-creators"> Creators
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-nft-ranking.html" class="nav-link"
                                                    data-key="t-ranking"> Ranking
                                                </a>
                                            </li>
                                            <li class="nav-item">
