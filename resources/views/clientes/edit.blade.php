    ...
    <form action="{{ route('clientes.update', $cliente->id) }}" method="POST">
        ...
        <div class="row mt-2">
            <div class="col-xxl-12 col-md-12">
                ...
                <input type="text" class="form-control" id="address" name="address" value="{{ old('address', $cliente->endereco->address ?? '') }}" required>
            </div>
            <div class="col-xxl-4 col-md-4">
                <label for="city" class="form-label">Cidade</label>
                <input type="text" class="form-control" id="city" name="city" value="{{ old('city', $cliente->endereco->city ?? '') }}" required>
            </div>
            <div class="col-xxl-4 col-md-4">
                <label for="state" class="form-label">UF</label>
                <input type="text" class="form-control" id="state" name="state" value="{{ old('state', $cliente->endereco->state ?? '') }}" required>
            </div>
            <div class="col-xxl-4 col-md-4">
                <label for="zip_code" class="form-label">CEP</label>
                <input type="text" class="form-control" id="zip_code" name="zip_code" value="{{ old('zip_code', $cliente->endereco->zip_code ?? '') }}" required>
            </div>
        </div>
