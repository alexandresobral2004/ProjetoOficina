                ...
                <table id="example" class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                    <thead>
                        <tr>
                            ...
                            <th data-ordering="false">Ano</th>
                            <th data-ordering="false">ID proprietário</th>
                        </tr>
                    </thead>
                    <tbody>
                                ...
                                <td>
                                    <div class="dropdown d-inline-block d-flex justify-content-center align-items-center">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <button class="dropdown-item view-client-btn" data-id="{{ $veiculo->id }}" data-bs-toggle="modal" data-bs-target="#viewClientModal">
                                                    <i class="ri-eye-fill align-bottom me-2 text-muted"></i> View
                                                </button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item edit-client-btn" data-id="{{ $veiculo->id }}" data-bs-toggle="modal" data-bs-target="#editClientModal">
                                                    <i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit
                                                </button>
                                            </li>
                                            <li>
                                                <button class="dropdown-item delete-client-btn" data-id="{{ $veiculo->id }}" data-bs-toggle="modal" data-bs-target="#deleteClientModal">
