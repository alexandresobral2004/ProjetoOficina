...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signup-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Aug 2024 20:49:29 GMT -->
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" action="{{ route('auth.registerSave') }}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input"
                                                    onpaste="return false" name="password" placeholder="Enter password"
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label" for="password-input">Confirme a Senha</label>
                                            <div class="position-relative auth-pass-inputgroup">
                                                <input type="password" class="form-control pe-5 password-input"
...
<!-- Mirrored from themesbrand.com/velzon/html/default/auth-signup-basic.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Aug 2024 20:49:31 GMT -->
